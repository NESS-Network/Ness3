...
run-integration-test-live-disable-csrf: ## Run the mdl node configured for live integration tests with CSRF disabled
	./ci-scripts/run-live-integration-test-node.sh -disable-csrf

run-integration-test-live-disable-networking: ## Run the mdl node configured for live integration tests with networking disabled
...
=======
run-integration-test-live-cover-disable-csrf: ## Run the mdl node configured for live integration tests with CSRF disabled and with coverage
	./ci-scripts/run-live-integration-test-node-cover.sh -disable-csrf
>>>>>>> release/0.27.1

run-integration-test-live-cover-disable-networking: ## Run the mdl node configured for live integration tests with networking disabled and with coverage
...
generate: ## Generate test interface mocks and struct encoders
	...
	goimports -w -local github.com/MDLlife/MDL ./src/visor/mock_unspent_pooler_test.go
